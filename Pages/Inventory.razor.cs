...
public partial class Inventory
{
    ...
    protected sealed override void OnInitialized()
    {
        ...
        SetAppBarTitle.Invoke("Cafe Products Management");
    ...
    private void ResetItemToOriginalValues(object element)
    {
        ...
        //inventory
        ((Spare)element).ItemType = ElementBeforeEdit.ItemType;
    ...
    private async Task AddDialog()
    {
        ...
        await DialogService.ShowAsync<AddSpareDialog>("Add Items", parameters);
    }
